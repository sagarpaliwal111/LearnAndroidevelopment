...
import com.sagarpaliwal.learnAndroiddevelopement.databinding.FragmentResultActivityQuizSecondBinding


class Result_Activity_Quiz_Second : Fragment(), BillingProcessor.IBillingHandler  {

    private val args: Result_Activity_Quiz_SecondArgs by navArgs()
    private lateinit var binding: FragmentResultActivityQuizSecondBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentResultActivityQuizSecondBinding.inflate(inflater, container, false)
