...
import com.sagarpaliwal.learnAndroiddevelopement.databinding.FragmentWebViewBinding


class WebView : Fragment(), BillingProcessor.IBillingHandler {
...
//                    )
        ...
        val webView = binding.webviewbbcc
        ...
        if (!preferences.getBoolean("isPremium", false)) {
            requireActivity().onBackPressedDispatcher.addCallback(this) {
                ...
                findNavController().navigate(R.id.action_webView_to_tutorialListFragment)
            }
        } else {
