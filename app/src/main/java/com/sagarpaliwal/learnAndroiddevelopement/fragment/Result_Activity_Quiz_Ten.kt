...
import com.sagarpaliwal.learnAndroiddevelopement.databinding.FragmentResultActivityQuizTenBinding


class Result_Activity_Quiz_Ten : Fragment(), BillingProcessor.IBillingHandler {

    private val args: Result_Activity_Quiz_TenArgs by navArgs()
    private lateinit var binding: FragmentResultActivityQuizTenBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentResultActivityQuizTenBinding.inflate(inflater, container, false)
