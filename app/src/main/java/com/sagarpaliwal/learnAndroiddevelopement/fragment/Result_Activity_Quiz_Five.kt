...
import com.sagarpaliwal.learnAndroiddevelopement.databinding.FragmentResultActivityQuizFiveBinding


class Result_Activity_Quiz_Five : Fragment(), BillingProcessor.IBillingHandler  {

    private val args: Result_Activity_Quiz_FiveArgs by navArgs()
    private lateinit var binding: FragmentResultActivityQuizFiveBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentResultActivityQuizFiveBinding.inflate(inflater, container, false)
