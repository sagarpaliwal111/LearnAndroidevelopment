...
import com.sagarpaliwal.learnAndroiddevelopement.databinding.FragmentJavaQuizFourBinding
import kotlinx.android.synthetic.main.fragment_java__quiz__first.*
import java.util.*
import java.util.concurrent.TimeUnit


class Java_Quiz_Four : Fragment(), BillingProcessor.IBillingHandler  {
    lateinit var binding: FragmentJavaQuizFourBinding
    ...
    private var questions = arrayOf(
        ...
        "4. ADB stands for",
        "5. Which is Not state of an activity",
        "6. Paused is used",
        "7. What is not used in monitoring an activity",
        "8. Select invalid state for a process",
        "9. What is AIDL?",
    ...
    override fun onCreateView(
        ...
        binding = FragmentJavaQuizFourBinding.inflate(inflater, container, false)
        initViews()
    ...
    private fun showNextQuestion() {
        ...
        try {
            ...
            if (qIndex <= questions.size - 1) {
                ...
                score = correct
                val action = Java_Quiz_FourDirections.actionJavaQuizFourToResultActivityQuizFour(
                    correct.toString(),
                    wrong.toString(),
                    skip.toString()
                )
