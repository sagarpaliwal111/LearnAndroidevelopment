...
import com.sagarpaliwal.learnAndroiddevelopement.databinding.FragmentResultActivityQuizThirdBinding


class Result_Activity_Quiz_Third : Fragment(), BillingProcessor.IBillingHandler  {

    private val args: Result_Activity_Quiz_ThirdArgs by navArgs()
    private lateinit var binding: FragmentResultActivityQuizThirdBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentResultActivityQuizThirdBinding.inflate(inflater, container, false)
