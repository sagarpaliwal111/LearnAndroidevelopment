...
import com.sagarpaliwal.learnAndroiddevelopement.databinding.FragmentResultActivityQuizEightBinding


class Result_Activity_Quiz_Eight : Fragment(), BillingProcessor.IBillingHandler  {

    private val args: Result_Activity_Quiz_EightArgs by navArgs()
    private lateinit var binding: FragmentResultActivityQuizEightBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentResultActivityQuizEightBinding.inflate(inflater, container, false)
