...
import com.sagarpaliwal.learnAndroiddevelopement.databinding.FragmentResultActivityQuizFirstBinding


class Result_Activity_Quiz_First : Fragment(), BillingProcessor.IBillingHandler  {

    private val args: Result_Activity_Quiz_FirstArgs by navArgs()
    private lateinit var binding: FragmentResultActivityQuizFirstBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentResultActivityQuizFirstBinding.inflate(inflater, container, false)
    ...
    private fun initializeViews() {
        ...
        binding.tvPlayAgain.setOnClickListener {
            ...
            if (!preferences.getBoolean("isPremium", false)) {
                ...
                findNavController().navigate(R.id.java_Quiz_First)
