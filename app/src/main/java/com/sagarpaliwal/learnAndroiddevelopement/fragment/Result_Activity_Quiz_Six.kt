...
import com.sagarpaliwal.learnAndroiddevelopement.databinding.FragmentResultActivityQuizSixBinding


class Result_Activity_Quiz_Six : Fragment(), BillingProcessor.IBillingHandler {

    private val args: Result_Activity_Quiz_SixArgs by navArgs()
    private lateinit var binding: FragmentResultActivityQuizSixBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentResultActivityQuizSixBinding.inflate(inflater, container, false)
