...
import com.sagarpaliwal.learnAndroiddevelopement.databinding.FragmentResultActivityQuizNineBinding


class Result_Activity_Quiz_Nine : Fragment(), BillingProcessor.IBillingHandler  {

    private val args: Result_Activity_Quiz_NineArgs by navArgs()
    private lateinit var binding: FragmentResultActivityQuizNineBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentResultActivityQuizNineBinding.inflate(inflater, container, false)
